...
**Production Server**: Consider that this project in production is running on a shared host in Hostinger and the code is located in the `public_html/` directory. The domain is `abertamente.net`.
